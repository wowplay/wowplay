...
<head>
    ...
    <script type="text/javascript" src="../../resources/back/js/jsapi.js"></script>
    <script type="text/javascript" src="../../resources/back/js/format+zh_CN,default,corechart.I.js"></script>
    <script type="text/javascript" src="../../resources/back/js/jquery.gvChart-1.0.1.min.js"></script>
    <script type="text/javascript" src="../../resources/back/js/jquery.ba-resize.min.js"></script>
...
<div class="mainbox">
    ...
    <div class="mainleft">
        ...
        <div class="leftinfos">
            ...
            <div class="inforight">
                ...
                <ul class="tooli">
                    <li><span><img src="../../resources/back/images/d01.png"/></span>
                        <p><a href="#">信息资料</a></p></li>
                    <li><span><img src="../../resources/back/images/d02.png"/></span>
                        <p><a href="#">编辑</a></p></li>
                    <li><span><img src="../../resources/back/images/d03.png"/></span>
                        <p><a href="#">记事本</a></p></li>
                    <li><span><img src="../../resources/back/images/d04.png"/></span>
                        <p><a href="#">任务日历</a></p></li>
                    <li><span><img src="../../resources/back/images/d05.png"/></span>
                        <p><a href="#">图片管理</a></p></li>
                    <li><span><img src="../../resources/back/images/d06.png"/></span>
                        <p><a href="#">交易</a></p></li>
                    <li><span><img src="../../resources/back/images/d07.png"/></span>
                        <p><a href="#">档案袋</a></p></li>
                </ul>
    ...
    <div class="mainright">
        ...
        <div class="dflist1">
            ...
            <ul class="newlist">
                <li><i><a>会员数：</a></i>2535462</li>
                <li><i><a>文档数：</a></i>5546</li>
                <li><i><a>普通文章：</a></i>2315</li>
                <li><i><a>软件：</a></i>1585</li>
                <li><i><a>评论数：</a></i>5342</li>
            </ul>
        </div>
